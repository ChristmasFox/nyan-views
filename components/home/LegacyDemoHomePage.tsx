...
interface LegacyDemoHomePageProps {
  displayGroups: DisplayGroup[]
}

/**
 * 原演示首页（大屏列表、计数、Redux 测试）。默认路由不再使用；需要调试时可单独挂到某路由。
 */
export default function LegacyDemoHomePage({ displayGroups }: LegacyDemoHomePageProps) {
